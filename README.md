...
This is a fork of [wharton/chef-coldfusion11](https://github.com/wharton/chef-coldfusion11) that basically uses every bit of the hard work put forth in that project and updates a few things to get the CF11 installer to work.
...
* `coldfusion11::standalone` - Installs Cold Fusion 11 in standalone mode
...
* `['urls']` - A list of update URLs to download and install. (default: `%w{
  http://download.adobe.com/pub/adobe/coldfusion/11/hotfix_001.jar
  http://download.adobe.com/pub/adobe/coldfusion/11/hotfix_002.jar
  http://download.adobe.com/pub/adobe/coldfusion/11/hotfix_003.jar
  http://download.adobe.com/pub/adobe/coldfusion/11/hotfix_004.jar
  http://download.adobe.com/pub/adobe/coldfusion/11/hotfix_005.jar
...
`coldfusion11::updates` recipes, installing Cold Fusion 11 standalone server mode.
...
Below are the explanations for additional ColdFusion pieces that can be blocked. Cold Fusion 11 server lockdown documentation can be found here: http://www.adobe.com/content/dam/Adobe/en/products/coldfusion/pdfs/cf11/cf11-lockdown-guide.pdf
